  ...
  const unsubscribe = onSnapshot(
    ...
    (snapshot) => {
      ...
      // وصول طلب جديد
        ...
        list.length > previousOrdersCount.current
      ) {
...
const getCategoryTreeOptions = (
  ...
  categories
    ...
    .forEach(cat => {
      ...
      // منع القسم من اختيار نفسه كقسم أب
...
>
  ...
  {getCategoryTreeOptions().map(cat => (
    <option
      key={cat.id}
      value={cat.id}
    >
...
<select
  ...
  onChange={
    e => setCategoryParentId(e.target.value)
  }
>
